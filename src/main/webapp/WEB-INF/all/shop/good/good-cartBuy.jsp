   ...
   <body>
     ...
     <%@ include file="/WEB-INF/all/include/shop-begin.jsp"%>
	  ...
	  <div class="container cart">
		...
		<!--购物车商品-->
		<div class="row">
		 <form id="cart-to-buy" action="${pageContext.request.contextPath}/shop/order/cartAdd" method="POST">
		 <c:forEach items="${cartSkus}" var="cartSku" varStatus="statu">
		  <div id="" class="panel panel-default">
		    <div class="panel-body cart-goods">	
		      <input id="order-cartSku-${cartSku.id}" hidden="" name="cartSkuIds" value="${cartSku.id}" />		
