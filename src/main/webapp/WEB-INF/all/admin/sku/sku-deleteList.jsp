		   ...
		   <c:forEach var="pageSku"   items="${pageInfo.getList()}" varStatus="statu" >
		     ...
		     <tr id="${pageSpu.id}" class="tr">
			  ...
			  <td>	
			   ...
			   <a href="javascript:deleteByID(${pageSku.id},'${pageContext.request.contextPath}/admin/sku/sku/delete');" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i>&nbsp;<span>删除</span></a>			   			 			   
			  </td>
			</tr>		   
		   </c:forEach>
