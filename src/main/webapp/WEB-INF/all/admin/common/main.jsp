  ...
  <body>
     <div class="header-top">
	   <div class="container-fluid">
	     <div class="row">
		   <div class="col-md-1">
		     <a href="${pageContext.request.contextPath}/admin/common/main"><img class="img-responsive" alt="凯之家" src="${pageContext.request.contextPath}/resources/image/logo/kenhome-white.png" style="margin-top:30px;"></a>
		   </div>
		   <div class="col-md-11">
		     <div class="row">
			...
			<div class="row">
		      <div class="col-md-12" style="height:25px;margin-top:10px;line-height:25px;">  
	     ...
	     <div class="col-md-1 leftbar">
		   <ul class="nav nav-pills nav-stacked leftbar-ul">
		      ...
		      <c:forEach items="${secondGradeAcls}" var="eachSecond">
		         ...
		         <li data-parentID="${eachSecond.parentId}" class="nav-left-bar" style="display:none;margin:0px;padding:0px;" ><a style="margin:0px;padding:15px 35px;" class="nav-leftItem" href="${pageContext.request.contextPath}${eachSecond.aclUrl}"><span></span>${eachSecond.aclName}</a></li>
